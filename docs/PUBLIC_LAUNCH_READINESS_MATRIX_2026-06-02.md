...
| Recruiter workspace analytics `/recruiter/analytics` | `docs/RECRUITER_ANALYTICS_MVP_2026-06-11.md` — company-slug aggregates; workspace/demo disclaimer; `test:recruiter-analytics-mvp` | ✅ **PASS** (pilot) — workspace-scoped only; public launch **NO-GO** unchanged |
