...
- **Phase 3B controlled multitab (2026-06-17):** `docs/PHASE3B_CONTROLLED_MULTITAB_VERIFICATION_2026-06-17.md` — **PARTIAL** (local 21/21 PASS @ `fda7567`; prod `4bb425d` + Playwright crash); `test:phase3b-controlled-multitab`; P0 **OPEN→PARTIAL**; launch **NO-GO** unchanged
