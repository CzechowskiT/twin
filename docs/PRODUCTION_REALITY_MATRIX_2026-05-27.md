...
| Recruiter Talent Radar `/recruiter/talent-radar` | `docs/RECRUITER_TALENT_RADAR_MVP_2026-06-12.md` — `GET /api/v1/recruiter/talent-radar`; explainable resurfacing from internal context; draft-only outreach; `test:recruiter-talent-radar-mvp` | **PILOT** — Sourcing Memory Agent; **no** auto outreach / external sourcing; public launch **NO-GO** |
