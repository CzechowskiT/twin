...
| CSP S2 burn-in window (2026-06-02) | `docs/S2_CSP_BURNIN_WINDOW_2026-06-01.md` — `2026-06-02T14:18:33Z` → `2026-06-05T14:18:33Z` (~22h 5m / ~31% elapsed at `2026-06-03T12:23:52Z`) | **IN PROGRESS** — S2 PASS **NO**; enforce off |
| CSP founder Railway checkpoint (2026-06-03 `12:23:52Z`) | Founder UI search `csp_report` from window start — **no fresh entries**; agent `audit-csp-headers.sh` + public-health corroboration | **CONTINUE** — report-only HOLD; clears prior Railway **PENDING** |
