...
| Company Talent Pool View `/company/talent-pool` | `docs/COMPANY_TALENT_POOL_VIEW_MVP_2026-06-15.md` — `GET /api/v1/company/talent-pool`; executive summary + NBA + readiness guide + premium workspace selector; reuses migration 059; `test:company-talent-pool-view-mvp` + `test:company-talent-pool-executive-ux` | **PILOT** — organizational talent memory; **no** PII / auto outreach / live ATS; public launch **NO-GO** |
