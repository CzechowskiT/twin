...
- **Performance-safe moving logo marquee (2026-06-16, logo quality 2026-06-17):** `docs/PERFORMANCE_SAFE_MOVING_LOGO_MARQUEE_2026-06-16.md` — ≤27 DOM nodes (9×3 segments) on workspace/auth with curated local wordmarks; marketing lazy-loads full strip; `test:performance-safe-moving-logo-marquee` + `test:performance-safe-moving-logo-marquee-browser`
