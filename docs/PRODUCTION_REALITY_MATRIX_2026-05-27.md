...
| Recruiter compliance audit trail | `docs/RECRUITER_COMPLIANCE_AUDIT_TRAIL_MVP_2026-06-11.md` — append-only `recruiter_audit_events`; accept/decline + review-open; no decline notes in ledger; `test:recruiter-audit-trail-mvp` | **LIVE (pilot)** — inbox token scope; migration `052_recruiter_audit_events`; public launch **NO-GO** |
