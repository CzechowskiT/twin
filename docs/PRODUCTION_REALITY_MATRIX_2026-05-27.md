...
| Weekly Talent Radar Digest `/recruiter/talent-radar/digest` | `docs/RECRUITER_TALENT_RADAR_WEEKLY_DIGEST_2026-06-15.md` — `GET /api/v1/recruiter/talent-radar/digest`; dashboard + copy summary; `test:recruiter-talent-radar-weekly-digest` | **PILOT** — **no** email send / auto outreach; public launch **NO-GO** |
