...
- **Auto-apply / delegated apply:** **PAUSED** / **NOT LIVE** — gates live (`e764e68` / `6382a91`); **GAP-03/04 open on prod** (beat ON, submit default true). Ops pause playbook: `docs/AUTO_APPLY_PRODUCTION_OPS_PAUSE_PLAN_2026-06-02.md` — **recommended Option B** (founder executes Railway; agent does not).
