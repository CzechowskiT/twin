...
| 2026-05-29 | founder (reported) | Manual backup **2026-05-25 07:33 UTC** (~120 MB) | **production Postgres** (suspected in-place restore) | **FAIL / INCIDENT** | unknown | UI "Restoring backup…"; post-restore dashboard zeros | Founder report + agent read-only health (`db_ok=true`, `mvp-stats` **500**) | **NO-GO** | **NOT O7** — production data incident `INC-DB-2026-05-29-001`; see `docs/PRODUCTION_DB_RESTORE_INCIDENT_2026-05-29.md`. O7 staging clone drill still **PENDING EVIDENCE**. |
