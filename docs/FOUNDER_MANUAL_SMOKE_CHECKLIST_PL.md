...
| 2026-05-29 | founder | **PARTIAL** (screenshots) | nie | Większość tras PASS; `/dashboard` layout FAIL (naprawa FE); Google Calendar **FULL prod smoke PASS** (OAuth + wydarzenia + mapowanie dni) — `docs/GOOGLE_CALENDAR_OAUTH_PROD_FIX_2026-05-29.md` |
