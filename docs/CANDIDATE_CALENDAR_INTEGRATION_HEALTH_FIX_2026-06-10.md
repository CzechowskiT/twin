...
| `CANDIDATE_CALENDAR_INTEGRATION_INCIDENT_2026-06-11.md` | Connected + **BŁĄD INTEGRACJI** on both cards; week panel disconnect/reconnect copy | Fixed — decouple connection vs events-read; state-specific PL/EN copy |
