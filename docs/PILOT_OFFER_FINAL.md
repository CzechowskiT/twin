...
**Cel:** jakościowe rozmowy kwalifikacyjne na kalendarzu — nie masowe wysyłanie CV.
...
- **Śledzenie aplikacji** — statusy i akceptacja matchy w jednym workspace.
- **Kalendarz** — zaproszenia / holdy na rozmowy (Google Calendar tam, gdzie skonfigurowane; ICS jako fallback).
...
- Operacje kandydata: [PILOT_CANDIDATE_INTAKE.md](./PILOT_CANDIDATE_INTAKE.md)
- Arkusz per osoba: [PILOT_TRACKER.csv](./PILOT_TRACKER.csv) + [PILOT_TRACKER_GUIDE.md](./PILOT_TRACKER_GUIDE.md)
- Tygodniowy north star: [PILOT_TRACTION_DASHBOARD.md](./PILOT_TRACTION_DASHBOARD.md)
