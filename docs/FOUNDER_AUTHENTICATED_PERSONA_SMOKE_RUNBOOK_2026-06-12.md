...
| R4c | `/recruiter/talent-radar/digest` | Summary cards + sections or premium empty; **Copy summary** only (no send) | Pilot; period selector; trust chips | Email send or auto outreach implied |
