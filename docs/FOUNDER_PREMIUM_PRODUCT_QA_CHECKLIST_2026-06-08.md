...
| 1.5 | Calendar OAuth return (`?calendar_connected=1`) | Success banner readable on dark: **Kalendarz połączony** + body copy; auto-dismiss ~7s (`docs/CANDIDATE_CALENDAR_SUCCESS_ALERT_POLISH_2026-06-10.md`) |
