/**
 * Production wrapper — commit gate then calendar readiness evidence browser smoke.
 */
...
async function main(): Promise<void> {
  ...
  const result = spawnSync("npm", ["run", "test:calendar-readiness-evidence-browser:raw"], {
    cwd: scriptRoot,
    env,
    stdio: "inherit",
    shell: true,
