/**
 * Production wrapper — commit gate then candidate calendar readiness browser smoke.
 */
...
async function main(): Promise<void> {
  ...
  const result = spawnSync("npm", ["run", "test:candidate-calendar-readiness-browser:raw"], {
    cwd: scriptRoot,
    env,
    stdio: "inherit",
    shell: true,
