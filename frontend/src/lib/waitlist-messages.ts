...
function esCopy(): WaitlistCopyBase {
  return {
    ...en,
    metaTitle: "TWIN Wishlist — agente de carrera founding",
    metaDescription:
      "Primeros 1.000 founding: ranking hasta 200 ofertas, estados honestos, ~30 adaptadores de fuentes. Alta gratuita — sin tarjeta.",
    backHome: "← Inicio",
    heroHeadline: "TU AGENTE DE CARRERA — RANKING, ESTADOS HONESTOS",
    heroLead1: "Wishlist → invitación founding → registro → CV → perfil.",
    ...
    sectionStats: "Wishlist en vivo",
    metricSpots: "Cupo founding",
    ...
    boostRewards: "Recompensa = acceso founding antes, no bonos en dólares.",
    ...
    faq: [
      ...
      {
        q: "¿Qué pasa tras unirme a la wishlist?",
        a: "Entras en la cola founding (cupo 1.000). Cuando abra tu slot, invitación a registrarte, subir CV y crear perfil.",
      },
      {
      ...
      {
        q: "¿Cuánto cuesta founding?",
        a: "La wishlist es gratis y sin tarjeta. La cohorte founding tiene early access gratis; planes de pago pueden llegar después con condiciones publicadas antes.",
      },
      {
    ...
    finalTitle: "Únete a la wishlist founding",
    ...
    formSubmit: "Unirme a la wishlist founding",
    formBullet1: "✓ Primeros 1.000 founding — sin tarjeta hoy",
...
function frCopy(): WaitlistCopyBase {
  return {
    ...en,
    metaTitle: "TWIN Wishlist — agent carrière founding",
    metaDescription:
      "Premiers 1 000 founding : ranking jusqu'à 200 offres, statuts honnêtes, ~30 adaptateurs sources. Inscription gratuite — sans carte.",
    backHome: "← Accueil",
    heroHeadline: "VOTRE AGENT CARRIÈRE — RANKING, STATUTS HONNÊTES",
    heroLead1: "Wishlist → invitation founding → inscription → CV → profil.",
    ...
    sectionStats: "Wishlist en direct",
    metricSpots: "Plafond founding",
    ...
    boostRewards: "Récompense = accès founding plus tôt, pas de bonus en dollars.",
    ...
    faq: [
      ...
      {
        q: "Que se passe-t-il après la wishlist ?",
        a: "Vous entrez dans la file founding (plafond 1 000). À l'ouverture de votre slot : invitation à vous inscrire, déposer CV et profil.",
      },
      {
      ...
      {
        q: "Combien coûte founding ?",
        a: "Wishlist gratuite, sans carte. La cohorte founding a un early access gratuit ; offres payantes possibles plus tard avec conditions publiées avant.",
      },
      {
    ...
    finalTitle: "Rejoindre la wishlist founding",
    finalLead: "Premiers 1 000 · inscription gratuite · façonnez l'agent avant l'échelle",
    formSubmit: "Rejoindre la wishlist founding",
    formBullet1: "✓ Premiers 1 000 founding — sans carte aujourd'hui",
...
function deCopy(): WaitlistCopyBase {
  return {
    ...en,
    metaTitle: "TWIN Wishlist — Founding-Karriereagent",
    metaDescription:
      "Erste 1.000 Founding: Ranking bis 200 Jobs, ehrliche Bewerbungsstatus, ~30 Quell-Adapter. Kostenlose Wishlist — keine Karte.",
    backHome: "← Startseite",
    heroHeadline: "DEIN KARRIEREAGENT — RANKING, EHRLICHE STATUS",
    heroLead1: "Wishlist → Founding-Einladung → Registrierung → CV → Profil.",
    ...
    boostRewards: "Belohnung = früherer Founding-Zugang, keine Dollar-Boni.",
    ...
    faq: [
      ...
      {
        q: "Was passiert nach der Wishlist?",
        a: "Du bist in der Founding-Queue (Limit 1.000). Bei freiem Slot: Einladung zu Registrierung, CV-Upload und Profil.",
      },
      {
      ...
      {
        q: "Was kostet Founding?",
        a: "Wishlist ist kostenlos ohne Karte. Founding-Kohorte erhält kostenlosen Early Access; bezahlte Pläne ggf. später — Bedingungen zuerst veröffentlicht.",
      },
      {
    ...
    finalTitle: "Founding-Wishlist beitreten",
    finalLead: "Erste 1.000 · kostenlose Anmeldung · Agent vor Skalierung mitgestalten",
    formSubmit: "Founding-Wishlist beitreten",
    formBullet1: "✓ Erste 1.000 Founding — heute keine Karte",
...
function itCopy(): WaitlistCopyBase {
  return {
    ...en,
    metaTitle: "TWIN Wishlist — agente carriera founding",
    metaDescription:
      "Primi 1.000 founding: ranking fino a 200 offerte, stati candidatura onesti, ~30 adapter sorgenti. Iscrizione gratuita — nessuna carta.",
    backHome: "← Home",
    heroHeadline: "IL TUO AGENTE CARRIERA — RANKING, STATI ONESTI",
    heroLead1: "Wishlist → invito founding → registrazione → CV → profilo.",
    ...
    boostRewards: "Ricompensa = accesso founding prima, non bonus in dollari.",
    ...
    faq: [
      ...
      {
        q: "Cosa succede dopo la wishlist?",
        a: "Entri nella coda founding (cap 1.000). All'apertura dello slot: invito a registrarti, caricare CV e profilo.",
      },
      {
      ...
      {
        q: "Quanto costa founding?",
        a: "Wishlist gratuita, senza carta. Cohort founding con early access gratuito; piani a pagamento possibili dopo — condizioni prima del billing.",
      },
      {
    ...
    finalTitle: "Unisciti alla wishlist founding",
    finalLead: "Primi 1.000 · iscrizione gratuita · modella l'agente prima della scala",
    formSubmit: "Unisciti alla wishlist founding",
    formBullet1: "✓ Primi 1.000 founding — nessuna carta oggi",
...
function zhCopy(): WaitlistCopyBase {
  return {
    ...en,
    metaTitle: "TWIN Wishlist — founding 职业代理",
    metaDescription:
      "前 1000 名 founding：最多 200 个排序职位、诚实申请状态、约 30 个来源适配器。免费候补 — 无需信用卡。",
    backHome: "← 首页",
    heroHeadline: "你的职业代理 — 排序职位，诚实状态",
    heroLead1: "候补 → founding 邀请 → 注册 → 简历 → 档案。",
    heroLead2: "最多 200 个排序角色 · 先看前 20 · 每个职位可反馈。",
    heroLead3: "值得赴约的面试日历 — 不是收件箱噪音。",
    sectionStats: "候补实时",
    metricSpots: "Founding 名额",
    metricSigned: "已登记",
    ...
    boostRewards: "奖励 = 更早的 founding 访问，不是美元奖金。",
    ...
    faq: [
      ...
      {
        q: "加入候补后会发生什么？",
        a: "进入 founding 队列（上限 1000）。轮到你的名额时，收到注册、上传简历和建立档案的邀请。",
      },
      {
        q: "排序如何工作？",
      ...
      {
        q: "founding 费用多少？",
        a: "候补免费且无需信用卡。founding 队列有免费早期访问；付费计划可能稍后推出 — 计费前先公布条款。",
      },
      {
        q: "推荐如何运作？",
    ...
    finalTitle: "加入 founding 候补",
    finalLead: "前 1000 名 · 免费报名 · 在规模化前塑造代理",
    formSubmit: "加入 founding 候补",
    formBullet1: "✓ 前 1000 founding — 今天无需信用卡",
...
function jaCopy(): WaitlistCopyBase {
  return {
    ...en,
    metaTitle: "TWIN Wishlist — founding キャリアエージェント",
    metaDescription:
      "最初の1,000 founding：最大200件のランキング求人、正直な応募ステータス、約30のソースアダプター。無料ウェイトリスト — カード不要。",
    backHome: "← ホーム",
    heroHeadline: "あなたのキャリアエージェント — ランキング求人、正直なステータス",
    heroLead1: "ウェイトリスト → founding 招待 → 登録 → CV → プロフィール。",
    heroLead2: "最大200ロールをランキング · まずトップ20 · 求人ごとにフィードバック。",
    heroLead3: "赴く価値のある面接カレンダー — 受信トレイのノイズではない。",
    sectionStats: "ウェイトリスト（ライブ）",
    metricSpots: "Founding 定員",
    metricSigned: "リスト登録",
    metricRemaining: "残り枠",
    ...
    boostRewards: "報酬 = より早い founding アクセス。ドルボーナスではありません。",
    ...
    faq: [
      ...
      {
        q: "ウェイトリスト登録後は？",
        a: "founding キュー（上限1,000）に入ります。枠が開いたら、登録・CV・プロフィールの招待が届きます。",
      },
      {
        q: "ランキングの仕組みは？",
      ...
      {
        q: "founding の費用は？",
        a: "ウェイトリストは無料でカード不要。founding コホートは無料の early access。有料プランは後日の可能性 — 課金前に条件を公開。",
      },
      {
        q: "紹介の仕組みは？",
    ...
    finalTitle: "founding ウェイトリストに参加",
    finalLead: "最初の1,000 · 無料登録 · スケール前にエージェントを形作る",
    formSubmit: "founding ウェイトリストに参加",
    formBullet1: "✓ 最初の1,000 founding — 今日はカード不要",
...
function arCopy(): WaitlistCopyBase {
  return {
    ...en,
    metaTitle: "TWIN Wishlist — وكيل مهنة founding",
    metaDescription:
      "أول 1,000 founding: ترتيب حتى 200 وظيفة، حالات طلب صادقة، ~30 محول مصدر. قائمة انتظار مجانية — بدون بطاقة.",
    backHome: "← الرئيسية",
    heroHeadline: "وكيلك المهني — وظائف مرتبة، حالات صادقة",
    heroLead1: "قائمة الانتظار → دعوة founding → تسجيل → سيرة → ملف.",
    ...
    boostRewards: "المكافأة = وصول founding أبكر، وليس مكافآت بالدولار.",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "تدخل طابور founding (حد 1,000). عند فتح مكانك: دعوة للتسجيل ورفع السيرة والملف.",
      },
      {
        q: "كيف يعمل الترتيب؟",
      ...
      {
        q: "كم يكلف founding؟",
        a: "القائمة مجانية بدون بطاقة. مجموعة founding تحصل على early access مجاني؛ خطط مدفوعة قد تأتي لاحقاً — شروط قبل الفوترة.",
      },
      {
        q: "كيف تعمل الإحالات؟",
    ...
    finalTitle: "انضم إلى قائمة founding",
    finalLead: "أول 1,000 · تسجيل مجاني · شكّل الوكيل قبل التوسع",
    formSubmit: "انضم إلى قائمة founding",
    formBullet1: "✓ أول 1,000 founding — بدون بطاقة اليوم",
