...
const en = {
  ...
  dashboard: {
    ...
    nightlyAutoApplyLead:
      "TWIN applies autonomously to your best matches on a daily schedule (Pracuj.pl today).",
    nightlyAutoApplyEnable: "Enable autonomous applying",
...
const pl: MessageTree = {
  ...
  dashboard: {
    ...
    nightlyAutoApplyLead:
      "TWIN autonomicznie aplikuje do najlepszych dopasowań według harmonogramu (na razie Pracuj.pl).",
    nightlyAutoApplyEnable: "Włącz autonomiczne aplikowanie",
