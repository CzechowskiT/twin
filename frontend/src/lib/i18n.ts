...
const en = {
  ...
  home: {
    ...
    ctaDemoHint: "Nine-step product walkthrough with synthetic data. No account required.",
  ...
  strategic: {
    ...
    forecastRoles: "roles",
    forecastAutoApply: "Auto apply",
    forecastAutoApplyRunning: "Applying…",
...
const pl: MessageTree = {
  ...
  home: {
    ...
    ctaDemoHint: "Przewodnik w 9 krokach na danych syntetycznych. Bez konta.",
  ...
  strategic: {
    ...
    forecastStretch: "Stretch",
    forecastRoles: "ofert",
    forecastAutoApply: "Auto aplikuj",
    forecastAutoApplyRunning: "Aplikowanie…",
