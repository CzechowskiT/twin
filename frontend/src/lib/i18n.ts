...
const pl: MessageTree = {
  ...
  home: {
    ...
    featuresTitle: "Pipeline w skrócie",
    ...
    ctaDemoHint: "Dopasowania na żywo + symulacja auto-apply. Bez konta.",
  ...
  dashboard: {
    ...
    billingPageSubtitle:
      "Zainwestuj w spokojniejszy pipeline — ranking ofert, sloty rozmów i jedno miejsce na postęp. Ta sama obietnica co na wishliście founding.",
    ...
    billingStripeNotReadyPricing: "Cennik na wishlist",
    ...
    billingStripeSoonLead:
      "To normalne, dopóki na Railway nie ma kluczy Stripe (STRIPE_SECRET_KEY, STRIPE_PRICE_ID_PREMIUM). Plan darmowy działa w pełni — dołącz do wishlist na founding access albo zobacz docs/STRIPE.md, gdy chcesz live checkout.",
    billingCtaJoinWishlist: "Dołącz do wishlist",
    ...
    nightlyAutoApplyConsentAccept: "Zgadzam się — włącz auto-apply",
  ...
  login: {
    ...
    zoneRecruiterLead: "Inbox akceptacji i kalkulator ROI B2B do rozmów z klientem.",
  ...
  verifyEmail: {
    ...
    bannerBody: "Zweryfikuj e-mail, aby odblokować auto-apply i pełne funkcje konta.",
