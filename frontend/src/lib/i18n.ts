...
const en = {
  ...
  dashboard: {
    ...
    matchReasonTitle: "Why this role ranks for you",
  ...
  onboardingFlow: {
    ...
    profileBody: "Add your name, target titles, and location so matching knows your bar.",
  ...
  tutorial: {
    stepLabel: "Tip",
    matchesTitle: "Matched roles",
    matchesBody: "Scores reflect skills, titles, and salary fit — save or apply from the feed.",
...
const pl: MessageTree = {
  ...
  dashboard: {
    ...
    matchReasonTitle: "Dlaczego ta oferta jest wysoko",
  ...
  onboardingFlow: {
    ...
    profileBody: "Imię, docelowe stanowiska i lokalizacja — dopasowanie wie, pod jaki poziom oceniać oferty.",
  ...
  tutorial: {
    stepLabel: "Wskazówka",
    matchesTitle: "Dopasowane oferty",
    matchesBody: "Wynik uwzględnia umiejętności, tytuły i widełki — zapisuj lub aplikuj z listy.",
