...
const en = {
  ...
  workspace: {
    ...
    toolRecruiterAnalytics: "Workspace pipeline counts for your company slug — not marketplace traction.",
  ...
  investorMetrics: {
    ...
    lead:
      "Executive readiness view sourced from production reality matrices and public-health — no ARR, MRR, user counts, or conversion theater.",
    transparencyTitle: "Strict no-fake-traction policy",
    transparencyBody:
      "This dashboard lists module readiness and safe technical signals only. Scenario economics live in the calculator — illustrative, not audited financials.",
    launchStanceTitle: "Public launch stance",
    launchStanceNoGo: "NO-GO",
    launchStanceDetail:
      "Controlled pilot and investor review lanes only. Public launch remains blocked until founder gates clear (see PUBLIC_LAUNCH_READINESS_MATRIX).",
    controlledReviewTitle: "Controlled review readiness",
    controlledReviewH5c: "H5c HOLD · H5d pack ready",
    controlledReviewDetail:
      "H5b founder dry run PASS. H5c GO SMALL 1 prep pack ready for slot-1 visual review. External recruiter invitations deferred until explicit GO SMALL 1/2.",
    externalInvitesTitle: "External recruiter invitations sent",
    externalInvitesNote: "Zero until founder selects H5d slot-1 and issues GO SMALL — not a marketing cohort counter.",
    productReadinessTitle: "Product readiness",
    productReadinessLead: "Phase 1 MVP — honest module tiers aligned with docs/PRODUCTION_REALITY_MATRIX.",
    ...
    modLiveCandidateAuth: "Candidate OAuth login, dashboard, profile & applications transparency",
    modLiveJobMatching: "Job corpus, profile-aware ranking, Polish boards (pilot coverage)",
    modLiveGoogleCalendar: "Google Calendar OAuth — verified prod smoke (Europe/Warsaw week mapping)",
    modLiveRecruiterInbox: "Recruiter decision inbox — match score, review card, accept/decline (H4/H5b PASS)",
    modLiveStripeWaitlist: "Stripe checkout wiring, beta waitlist signup, mail when configured",
    modLiveCompliance: "GDPR consent, cookie banner, privacy/terms, CSP enforce live",
    modLiveInvestorWorkspace: "Investor data room metadata, scenario calculator, this reality dashboard",
    modDemoInteractiveDemo: "Interactive /demo walkthrough — synthetic timeline, not production usage",
    modDemoIcsWebcal: "ICS/WebCal interview holds — partial; Apple OAuth not available",
    modDemoPlacementVerification: "Placement verification state machine — pilot-scale, minimal prod volume",
    modDemoInvestorSeed: "Investor demo seed — curated stack for diligence walkthroughs",
    ...
    modNotLiveRecruiterCalendar: "Recruiter calendar sync (/recruiter/calendar placeholder)",
    modNotLiveExternalInvites: "External recruiter invitation sends (H5c/H5d HOLD)",
    modNotLiveRecruiterIntegrations: "ATS, LinkedIn, outbound email automation integrations",
    technicalHealthTitle: "Technical health (public)",
    technicalHealthLead: "Safe fields from GET /api/public-health — no secrets, DSNs, or admin-only ops flags.",
    ...
    roadmapMilestone1Body: "PASS — enforce live; 24h monitoring complete. Public launch still NO-GO.",
    roadmapMilestone2Title: "H5c slot-1 controlled recruiter visual review",
    roadmapMilestone2Body: "Prep pack ready; default HOLD until founder GO SMALL 1/2.",
    roadmapMilestone3Title: "Microsoft 365 calendar + ICS/WebCal parity copy",
    roadmapMilestone3Body: "Graph OAuth when configured; Apple remains ICS/WebCal partial with disclosure.",
    roadmapMilestone4Title: "Limited public launch founder decision",
    roadmapMilestone4Body: "Requires explicit GO after H5d cohort rules — not implied by feature merges.",
  ...
  investorDataRoom: {
    ...
    title: "Investor data room",
    lead:
      "Public architecture summaries and live traction surfaces — cap table, financials, and legal packs are shared manually after founder review.",
    confidentialLabel: "Confidential materials by request only",
    accessNotAutomatedNote:
      "Access is not automated. TWIN does not unlock diligence files in-product — email the founder with your fund name and the materials you need.",
    publicDocsTitle: "Public documentation",
    publicDocsLead:
      "These repository documents are intentionally public — product architecture, launch stance, and verification design. No private attachments.",
    publicDocPlacementVerificationTitle: "Placement verification architecture",
    publicDocPlacementVerificationSummary:
      "Machine-assisted, in-product placement confirmation — no default human email ping-pong.",
    publicDocProductionRealityTitle: "Production reality matrix",
    publicDocProductionRealitySummary:
      "What is live vs pilot vs not shipped — honest NO-GO / NOT LIVE labels for diligence.",
    publicDocPublicLaunchReadinessTitle: "Public launch readiness matrix",
    publicDocPublicLaunchReadinessSummary:
      "Launch gate checklist with explicit NO-GO posture and blockers.",
    publicDocLaunchGateChecklistTitle: "Public launch gate checklist",
    publicDocLaunchGateChecklistSummary:
      "Operator checklist aligned with the readiness matrix — no marketing GO claims.",
    surfacesTitle: "Live traction surfaces",
    surfacesLead: "In-product dashboards and JSON exports you can inspect without signing an NDA.",
    surfaceLiveMetrics: "Live metrics dashboard",
    surfaceSystemStatus: "System status",
    surfaceMvpStatsJson: "Download MVP stats JSON",
    surfaceOpenApi: "OpenAPI schema",
    surfaceScenarioCalculator: "Scenario calculator export",
    confidentialTitle: "Confidential (manual review)",
    confidentialLead:
      "The items below are not hosted in this workspace. Request them by email — we respond manually after verifying your fund and use case.",
    confidentialCapTable: "Cap table & dilution",
    confidentialFinancials: "Financial statements",
    confidentialLegalPack: "Legal & compliance pack",
    confidentialByRequestOnly: "Available by founder approval only — not downloadable here.",
    founderTitle: "Founder contact",
    founderLead:
      "For deck walk-throughs, diligence Q&A, or confidential pack requests — reach the founding team directly.",
    founderEmailLabel: "Email",
    requestAccessCta: "Request access by email",
    requestMailSubject: "TWIN investor data room — access request",
  ...
  companyBilling: {
    ...
    title: "Plan & usage",
    lead:
      "Transparent pilot status for your company workspace — honest plan labels, workspace counters when data exists, and integration readiness. No invoices, no payment activation.",
    navPlan: "Plan & usage",
    navAria: "Company workspace",
    billingNotLiveTitle: "Billing not live",
    billingNotLiveBody:
      "Employer billing, Stripe Checkout, and self-serve invoices are not enabled in this environment. Candidate subscriptions may exist separately — this page is readiness only.",
    planLabel: "Plan status",
    planPilot: "Pilot",
    planDemo: "Demo workspace",
    planFree: "Exploratory / free",
    planScope: "Workspace scope: {company}",
    planScopeGeneric: "Enter your pilot access code and company to load workspace usage.",
    usageTitle: "Usage (this workspace)",
    usageRoles: "Open roles",
    usageCandidatesReviewed: "Candidates reviewed",
    usageTeamSeats: "Team access tokens",
    usageEmpty: "No usage counters yet for this company slug — publish roles or load the acceptance inbox to generate activity.",
    usageNote: "Counts come from your TWIN workspace data only — not marketplace totals or revenue.",
    loading: "Loading usage…",
    loadFailed: "Could not load plan & usage for this workspace.",
    loadCta: "Load plan & usage",
    missingAuth: "Enter your access code and company slug to load plan & usage.",
    integrationsTitle: "Integration readiness",
    integrationsLead:
      "What is configured vs roadmap for employer billing and hiring integrations — no fake “connected” badges.",
    integrationAtsTitle: "ATS",
    integrationAtsBody: "Hire webhooks and import/export are pilot-scope — no live two-way sync claimed here.",
    integrationBillingTitle: "Employer billing",
    integrationBillingBody: "B2B billing and success-fee checkout are not live — contact us for pilot terms.",
    integrationSsoTitle: "Employer SSO",
    integrationSsoBody: "Entra ID / Google Workspace SSO for recruiters is on the roadmap — token access today.",
    integrationCalendarTitle: "Team calendar",
    integrationCalendarBody: "Recruiter calendar sync is not live — candidate calendar is separate.",
    statusPlanned: "Planned",
    statusNotLive: "Not live",
    statusManualWorkflow: "Manual workflow",
    ctaTitle: "Request pilot or talk to us",
    ctaLead:
      "No payment flow on this page. Email the founder for pilot access or use company signup to join the waitlist.",
    ctaContact: "Contact founder",
    ctaWaitlist: "Company signup",
    ctaMailSubject: "TWIN company pilot / billing readiness",
    pilotHint:
      "This page exists so employers see plan reality before any contract — not to simulate paid accounts.",
  },
  acceptanceQueue: {
...
const pl: MessageTree = {
  ...
  investorMetrics: {
    ...
    lead:
      "Executive view z macierzy produkcyjnej i public-health — bez ARR, MRR, liczników użytkowników ani teatru konwersji.",
    transparencyTitle: "Polityka: zero fałszywej trakcji",
    transparencyBody:
      "Panel pokazuje gotowość modułów i bezpieczne sygnały techniczne. Ekonomia scenariusza jest w kalkulatorze — poglądowa, bez audytowanych finansów.",
    launchStanceTitle: "Stance publicznego launchu",
    launchStanceNoGo: "NO-GO",
    launchStanceDetail:
      "Tylko kontrolowany pilot i ścieżki inwestorskie. Publiczny launch zablokowany do decyzji founder'a (PUBLIC_LAUNCH_READINESS_MATRIX).",
    controlledReviewTitle: "Gotowość kontrolowanego review",
    controlledReviewH5c: "H5c HOLD · pakiet H5d gotowy",
    controlledReviewDetail:
      "H5b founder dry run PASS. Pakiet H5c GO SMALL 1 gotowy do slot-1 visual review. Zaproszenia zewnętrzne wstrzymane do GO SMALL 1/2.",
    externalInvitesTitle: "Wysłane zaproszenia rekruterów zewnętrznych",
    externalInvitesNote: "Zero do czasu wyboru slot-1 H5d i GO SMALL — to nie licznik kohorty marketingowej.",
    productReadinessTitle: "Gotowość produktu",
    productReadinessLead: "MVP fazy 1 — uczciwe tiery modułów zgodne z docs/PRODUCTION_REALITY_MATRIX.",
    productReadinessBadge: "Pilot przed launchiem",
    modulesLiveTitle: "Moduły live",
    modulesDemoTitle: "Moduły demo / pilot",
    modulesNotLiveTitle: "Nie live",
    modLiveCandidateAuth: "OAuth kandydata, dashboard, profil i transparentność aplikacji",
    modLiveJobMatching: "Korpus ofert, ranking profilu, polskie portale (pokrycie pilota)",
    modLiveGoogleCalendar: "Google Calendar OAuth — zweryfikowany prod smoke (Europe/Warsaw)",
    modLiveRecruiterInbox: "Inbox rekrutera — match score, review card, accept/decline (H4/H5b PASS)",
    modLiveStripeWaitlist: "Stripe checkout, beta waitlist, mail gdy skonfigurowany",
    modLiveCompliance: "RODO, baner cookies, privacy/terms, CSP enforce live",
    modLiveInvestorWorkspace: "Data room, kalkulator scenariusza, ten panel reality",
    modDemoInteractiveDemo: "Interaktywne /demo — syntetyczna oś czasu, nie użycie produkcyjne",
    modDemoIcsWebcal: "ICS/WebCal na rozmowy — częściowo; brak Apple OAuth",
    modDemoPlacementVerification: "Maszyna stanów placementu — skala pilota, minimalny wolumen prod",
    modDemoInvestorSeed: "Seed demo inwestora — kuratorowany stack do diligence",
    modNotLivePublicLaunch: "Niekontrolowany publiczny launch",
    modNotLiveAutoApply: "Nocny beat auto-apply — WSTRZYMANY (ops + bramki produktu)",
    modNotLiveDelegatedApply: "Delegated / KYC auto-submit",
    modNotLiveRecruiterCalendar: "Sync kalendarza rekrutera (placeholder /recruiter/calendar)",
    modNotLiveExternalInvites: "Wysyłka zaproszeń rekruterów (H5c/H5d HOLD)",
    modNotLiveRecruiterIntegrations: "Integracje ATS, LinkedIn, automatyczna poczta wychodząca",
    technicalHealthTitle: "Zdrowie techniczne (publiczne)",
    technicalHealthLead: "Bezpieczne pola z GET /api/public-health — bez sekretów, DSN ani flag admin-only.",
    healthApi: "Status API",
    healthDatabase: "Baza danych",
    healthGit: "SHA deploy (skrót)",
    healthCelery: "Worker Celery",
    healthAutoApply: "Nocny beat auto-apply",
    healthScrape: "Worker scrape",
    healthOk: "OK",
    healthActive: "Aktywny",
    healthPaused: "Wstrzymany (ops)",
    healthUnavailable: "Niedostępny",
    roadmapTitle: "Kamienie milowe roadmapy (uczciwie)",
    roadmapLead: "Uporządkowane bramki — nie prognozy przychodu.",
    roadmapStep: "Kamień {step}",
    roadmapMilestone1Title: "S2 CSP enforce + monitoring po enforce",
    roadmapMilestone1Body: "PASS — enforce live; monitoring 24h zakończony. Public launch nadal NO-GO.",
    roadmapMilestone2Title: "H5c slot-1 kontrolowany visual review rekrutera",
    roadmapMilestone2Body: "Pakiet prep gotowy; domyślnie HOLD do GO SMALL 1/2.",
    roadmapMilestone3Title: "Microsoft 365 + copy parity ICS/WebCal",
    roadmapMilestone3Body: "Graph OAuth po konfiguracji; Apple pozostaje ICS/WebCal z ujawnieniem.",
    roadmapMilestone4Title: "Decyzja founder'a o limited public launch",
    roadmapMilestone4Body: "Wymaga jawnego GO po zasadach kohorty H5d — nie wynika z merge feature'ów.",
  ...
  investorDataRoom: {
    ...
    title: "Data room inwestora",
    lead:
      "Publiczne podsumowania architektury i live metryki — cap table, finanse i pakiet prawny udostępniamy ręcznie po weryfikacji przez founderów.",
    confidentialLabel: "Materiały poufne wyłącznie na żądanie",
    accessNotAutomatedNote:
      "Dostęp nie jest automatyczny. TWIN nie odblokowuje plików diligence w produkcie — napisz do founderów z nazwą funduszu i listą materiałów.",
    publicDocsTitle: "Dokumentacja publiczna",
    publicDocsLead:
      "Te dokumenty w repozytorium są celowo publiczne — architektura produktu, postawa launch i weryfikacja placement. Bez prywatnych załączników.",
    publicDocPlacementVerificationTitle: "Architektura weryfikacji placement",
    publicDocPlacementVerificationSummary:
      "Weryfikacja in-product wspierana maszynowo — bez domyślnego ping-pongu mailowego.",
    publicDocProductionRealityTitle: "Macierz rzeczywistości produkcyjnej",
    publicDocProductionRealitySummary:
      "Co jest live vs pilot vs niewysłane — uczciwe etykiety NO-GO / NOT LIVE do diligence.",
    publicDocPublicLaunchReadinessTitle: "Macierz gotowości public launch",
    publicDocPublicLaunchReadinessSummary:
      "Checklista bramki launch z jawną postawą NO-GO i blockerami.",
    publicDocLaunchGateChecklistTitle: "Publiczna checklista bramki launch",
    publicDocLaunchGateChecklistSummary:
      "Checklista operatora zgodna z macierzą — bez marketingowych deklaracji GO.",
    surfacesTitle: "Live powierzchnie trakcji",
    surfacesLead: "Dashboardy i eksporty JSON dostępne bez podpisywania NDA.",
    surfaceLiveMetrics: "Panel metryk live",
    surfaceSystemStatus: "Status systemu",
    surfaceMvpStatsJson: "Pobierz JSON metryk MVP",
    surfaceOpenApi: "Schemat OpenAPI",
    surfaceScenarioCalculator: "Eksport kalkulatora scenariuszy",
    confidentialTitle: "Poufne (ręczna weryfikacja)",
    confidentialLead:
      "Poniższe pozycje nie są hostowane w tym workspace. Poproś mailem — odpowiadamy ręcznie po weryfikacji funduszu i use case.",
    confidentialCapTable: "Cap table i rozwodnienie",
    confidentialFinancials: "Sprawozdania finansowe",
    confidentialLegalPack: "Pakiet prawny i compliance",
    confidentialByRequestOnly: "Dostępne po akceptacji founderów — bez pobierania tutaj.",
    founderTitle: "Kontakt do founderów",
    founderLead:
      "Walk deck, Q&A diligence lub prośba o pakiet poufny — bezpośrednio do zespołu założycielskiego.",
    founderEmailLabel: "E-mail",
    requestAccessCta: "Poproś o dostęp mailem",
    requestMailSubject: "TWIN data room inwestora — prośba o dostęp",
    contactFormCta: "Formularz kontaktowy",
    backInvestor: "Workspace inwestora",
  },
  recruiterJobs: {
...
function localeFromOverlays(
  ...
  const investorDataRoomOverlay = INVESTOR_DATA_ROOM_OVERLAYS[locale] ?? {};
