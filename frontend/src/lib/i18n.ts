...
const en = {
  ...
  dashboard: {
    ...
    developmentFocusLead:
      "When processes end without a hire, capture what you heard — TWIN structures gaps (tools, positioning, what others showed stronger) and merges them here so you can upskill before the next batch of applications.",
    ...
    appFeedbackHint:
      "Paste what they told you (missing tools, tone, depth). Save first, then extract a learning plan — with ANTHROPIC_API_KEY the model structures gaps; otherwise you still get a saved summary stub.",
    ...
    careerCompassPageLead:
      "Define your ideal next role — salary, work format, tools, responsibilities — and TWIN estimates where you stand, then lays out a time-bound, milestone path with XP and levels so progress feels tangible.",
...
const pl: MessageTree = {
  ...
  dashboard: {
    ...
    developmentFocusLead:
      "Gdy proces się kończy bez oferty, zapisz to, co usłyszałeś — TWIN strukturyzuje luki (narzędzia, sposób prezentacji, czym wyróżniali się inni) i scala je tutaj, żebyś mógł podciągnąć kompetencje przed kolejną falą aplikacji.",
    ...
    appFeedbackHint:
      "Wklej, co usłyszałeś (brakujące narzędzia, ton, głębia). Najpierw zapisz, potem wyciągnij plan rozwoju — przy ANTHROPIC_API_KEY model ustrukturyzuje luki; bez klucza i tak zapiszesz treść i krótki szkic.",
    ...
    careerCompassPageLead:
      "Zdefiniuj idealną następną rolę — wynagrodzenie, forma pracy, narzędzia, obowiązki — a TWIN oszacuje, gdzie jesteś, i ułoży ścieżkę w czasie z kamieniami milowymi, XP i poziomami, żeby postęp był namacalny.",
