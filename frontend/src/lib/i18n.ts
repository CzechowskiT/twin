...
const en = {
  ...
  onboardingFlow: {
    ...
    profileBody: "Add skills, titles, and CV text so matching can score roles against your bar.",
...
const pl: MessageTree = {
  ...
  onboardingFlow: {
    ...
    profileBody: "Dodaj umiejętności, tytuły i CV, żeby dopasowanie mogło oceniać oferty pod Twój poziom.",
