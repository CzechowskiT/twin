...
const en = {
  ...
  dashboard: {
    ...
    billingStripeSoonLead:
      "That’s expected until Stripe keys are on Railway (STRIPE_SECRET_KEY, STRIPE_PRICE_ID_PREMIUM). Your free plan is fully usable — join the wishlist for founding access, or follow docs/STRIPE.md when you want live checkout.",
  ...
  investorCalc: {
    ...
    referralRate: "Referral share of viral growth",
    referralRateNote:
      "New referred users = total users × viral growth % × this share. Referral tiers stack (activation + 3 months + hire) — not double-counted.",
    bonusActivation: "Bonus · first paid month ({amount})",
    bonusRetained3m: "Bonus · 3 paid months ({amount})",
    bonusHire: "Bonus · referred hire ({amount})",
    referralRetention3m: "Reach 3 paid months",
    sectionCandidateRewards: "Candidate reward programs (P&L)",
    programPlacement: "Placement success",
    programPlacementPnl: "Net success-fee revenue (≈25% monthly salary to TWIN after candidate share)",
    programReferral: "Refer a friend",
    programReferralPnl: "Cash tiers: {first} · {retained} · {hired} — annual cost below",
    programFounding: "Founding 1,000",
    programFoundingPnl: "Forgone Premium ARPU ({months} mo free × {cohort} cap) — subscription drag",
    programInterview: "Interview on calendar",
    programInterviewPnl: "{amount}/slot · max {max}/quarter — annual bonus cost below",
    foundingCohortSize: "Founding cohort cap",
    foundingFreeMonths: "Free Premium months (model year)",
    interviewAdoption: "Paying users with ≥1 slot bonus",
    interviewAvgSlots: "Avg slots per active user / year",
    interviewMaxPerQuarter: "Max slots per quarter (cap)",
    placementPayoutDelay: "Placement cash payout (illustrative delay)",
    placementPayoutDays: "{{n}} business days",
    rowReferralActivation: "Referral · first payment",
    rowReferralRetained3m: "Referral · 3 paid months",
    rowReferralHire: "Referral · referred hire",
    rowFoundingDrag: "Founding · forgone subscriptions",
    rowInterviewBonus: "Calendar interview bonuses",
    rowCandidateRewards: "Candidate reward costs",
    subscriptionGrossNote: "Gross subs before founding drag",
    candidateEconomicsTitle: "Candidate economics (USD example)",
    candidateEconomicsLead:
      "One paying Premium subscriber at current slider inputs — what they pay, receive, and what each party earns on a verified placement. Model amounts are USD; display currency only affects formatting below.",
    econCandidatePays: "Candidate pays (subscription)",
    econCandidatePaysDetail: "Blended monthly × 12 (annual prepay mix in sliders)",
    econFoundingBenefit: "Founding benefit (if in first 1,000)",
    econFoundingBenefitDetail: "Free Premium months — forgone revenue to TWIN, not a cash payout",
    econPlacementBonus: "Placement bonus (candidate cash)",
    econPlacementBonusDetail:
      "After verified hire · ~{pct}% of first monthly gross salary · paid ~{days} business days post-verification",
    econReferralActivation: "Referral · first paid month",
    econReferralActivationDetail: "When your referred friend pays their first subscription",
    econReferralRetained: "Referral · 3 paid months",
    econReferralRetainedDetail: "When referred friend completes 3 paid months",
    econReferralHire: "Referral · referred hire",
    econReferralHireDetail: "When referred friend is hired via TWIN (stacks with tiers above)",
    econReferralMaxStack: "Max stack if all tiers hit: {amount}",
    econInterviewBonus: "Interview calendar bonus",
    econInterviewBonusDetail: "Per confirmed slot · max {max}/quarter · up to {annual}/yr at cap",
    econEmployerPays: "Employer pays on placement",
    econEmployerPaysDetail: "{pct}% of candidate monthly salary (success fee)",
    econTwinNet: "TWIN net on placement",
    econTwinNetDetail: "After returning half the employer fee to candidate (~25% monthly salary baseline)",
    econTwinNetLinkedInNote: "LinkedIn viral program may reduce TWIN net on eligible hires (see sliders).",
...
const pl: MessageTree = {
  ...
  dashboard: {
    ...
    billingStripeSoonLead:
      "To normalne, dopóki na Railway nie ma kluczy Stripe (STRIPE_SECRET_KEY, STRIPE_PRICE_ID_PREMIUM). Plan darmowy działa w pełni — dołącz do listy founding na wczesny dostęp albo zobacz docs/STRIPE.md, gdy chcesz płatności na żywo.",
  ...
  investorCalc: {
    ...
    referralRate: "Udział poleceń we wzroście viral",
    referralRateNote:
      "Nowi poleconi = baza × wzrost viral % × ten udział. Poziomy się sumują (aktywacja + 3 miesiące + hire) — bez podwójnego liczenia.",
    bonusActivation: "Bonus · pierwsza płatność ({amount})",
    bonusRetained3m: "Bonus · 3 opłacone miesiące ({amount})",
    bonusHire: "Bonus · zatrudnienie poleconego ({amount})",
    referralRetention3m: "Dociera do 3 opłaconych miesięcy",
    sectionCandidateRewards: "Programy nagród kandydata (P&L)",
    programPlacement: "Bonus za placement",
    programPlacementPnl: "Przychód netto success fee (~25% mies. wynagrodzenia dla TWIN po udziale kandydata)",
    programReferral: "Poleć znajomego",
    programReferralPnl: "Progi: {first} · {retained} · {hired} — koszt roczny poniżej",
    programFounding: "Founding 1 000",
    programFoundingPnl: "Utracony ARPU Premium ({months} mies. gratis × limit {cohort}) — obniżka subskrypcji",
    programInterview: "Rozmowa w kalendarzu",
    programInterviewPnl: "{amount}/slot · max {max}/kwartał — koszt bonusów rocznie poniżej",
    foundingCohortSize: "Limit kohorty founding",
    foundingFreeMonths: "Miesiące darmowego Premium (rok modelu)",
    interviewAdoption: "Płacący z ≥1 bonusem za slot",
    interviewAvgSlots: "Śr. slotów na aktywnego / rok",
    interviewMaxPerQuarter: "Max slotów na kwartał (limit)",
    placementPayoutDelay: "Wypłata placement (opóźnienie ilustracyjne)",
    placementPayoutDays: "{{n}} dni roboczych",
    rowReferralActivation: "Polecenia · pierwsza płatność",
    rowReferralRetained3m: "Polecenia · 3 miesiące",
    rowReferralHire: "Polecenia · zatrudnienie",
    rowFoundingDrag: "Founding · utracone subskrypcje",
    rowInterviewBonus: "Bonusy za sloty w kalendarzu",
    rowCandidateRewards: "Koszty programów nagród",
    subscriptionGrossNote: "Suby brutto przed obniżką founding",
    candidateEconomicsTitle: "Ekonomia kandydata (przykład USD)",
    candidateEconomicsLead:
      "Jeden płacący subskrybent Premium przy bieżących suwakach — co płaci, co dostaje i ile zarabia każda strona przy zweryfikowanym placementcie. Model w USD; waluta wyświetlania zmienia tylko format.",
    econCandidatePays: "Kandydat płaci (subskrypcja)",
    econCandidatePaysDetail: "Miesięcznie × 12 (miks prepay rocznego w suwakach)",
    econFoundingBenefit: "Benefit founding (jeśli w pierwszej 1 000)",
    econFoundingBenefitDetail: "Miesiące darmowego Premium — utracony przychód TWIN, nie wypłata gotówki",
    econPlacementBonus: "Bonus za placement (gotówka kandydata)",
    econPlacementBonusDetail:
      "Po zweryfikowanym zatrudnieniu · ~{pct}% pierwszego mies. brutto · wypłata ~{days} dni rob. po weryfikacji",
    econReferralActivation: "Polecenie · pierwsza płatność",
    econReferralActivationDetail: "Gdy polecony znajomy opłaci pierwszą subskrypcję",
    econReferralRetained: "Polecenie · 3 opłacone miesiące",
    econReferralRetainedDetail: "Gdy polecony ukończy 3 opłacone miesiące",
    econReferralHire: "Polecenie · zatrudnienie poleconego",
    econReferralHireDetail: "Gdy polecony dostanie pracę przez TWIN (sumuje się z progami powyżej)",
    econReferralMaxStack: "Max suma progów: {amount}",
    econInterviewBonus: "Bonus za rozmowę w kalendarzu",
    econInterviewBonusDetail: "Za potwierdzony slot · max {max}/kwartał · do {annual}/rok przy limicie",
    econEmployerPays: "Pracodawca płaci przy placementcie",
    econEmployerPaysDetail: "{pct}% miesięcznego wynagrodzenia kandydata (success fee)",
    econTwinNet: "Netto TWIN z placementu",
    econTwinNetDetail: "Po oddaniu połowy opłaty pracodawcy kandydatowi (~25% mies. wynagrodzenia baseline)",
    econTwinNetLinkedInNote: "Program LinkedIn może obniżyć netto TWIN przy kwalifikujących się hire (suwaki).",
