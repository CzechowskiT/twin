...
const en = {
  ...
  investorMetrics: {
    ...
    lead: "Aggregate counts from production — no personal data. Refreshes on load.",
    calcLink: "Open investor calculator →",
    jobs: "Validated jobs",
...
const pl: MessageTree = {
  ...
  investorMetrics: {
    eyebrow: "Trakcja",
    title: "Metryki produktu na żywo",
    lead: "Agregaty z produkcji — bez danych osobowych. Odświeżane przy wejściu.",
    calcLink: "Kalkulator inwestora →",
    jobs: "Zweryfikowane oferty",
    users: "Zarejestrowani",
