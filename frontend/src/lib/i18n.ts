...
eyebrow: "Product roadmap",
  ...
  candidateControlCenter: {
    ...
    exportPreviewLead: "Preview what a data export would include — download disabled on pilot.",
    exportItemsLabel: "items in export bundle",
    exportCta: "Download export preview",
    exportDisabledHint: "Export download not live — preview only, no backend write.",
...
const pl: MessageTree = {
  ...
  candidateControlCenter: {
    ...
    exportPreviewLead: "Podgląd zawartości eksportu danych — pobieranie wyłączone w pilocie.",
    exportItemsLabel: "elementów w paczce eksportu",
    exportCta: "Pobierz podgląd eksportu",
    exportDisabledHint: "Pobieranie eksportu nie live — tylko podgląd, bez zapisu do backendu.",
