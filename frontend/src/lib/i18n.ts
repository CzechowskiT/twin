...
export type TranslationKey =
  ...
  | `companyDashboard.${keyof typeof en.companyDashboard}`
...
const en = {
  ...
  workspace: {
    ...
    gateLeadCompany:
      "Hiring dashboard and employer tools live in the company lane. Switch context or open your company home.",
...
eyebrow: "Product roadmap",
  ...
  recruiterAnalytics: {
    ...
    title: "Analytics",
    lead:
      "Counts from your acceptance inbox and pipeline for one company slug. Use this to see queue shape — not platform-wide traction.",
    demoDisclaimer: "Workspace/demo analytics — not marketplace traction.",
    scopeNote:
      "Scoped to your company token and slug only. No recruiter network totals, placement revenue, or time-to-hire benchmarks.",
    loading: "Loading workspace metrics…",
    loadFailed: "Could not load analytics — check your access code and company slug.",
    metricInReview: "In review",
    metricAccepted: "Accepted",
    metricRejected: "Rejected",
    metricOnHold: "On hold",
    metricInvited: "Invited / scheduled",
    metricAvgMatch: "Avg match score",
    metricMissingData: "Missing data",
    metricDecisionsWeek: "Decisions this week",
    metricTotal: "Total in workspace",
    noData: "—",
    funnelTitle: "Pipeline funnel",
    funnelHint: "Segment counts from your workspace applications — relative bars only.",
    segmentOnHold: "On hold",
    segmentInReview: "In review",
    segmentAccepted: "Accepted",
    segmentRejected: "Rejected",
    generatedAt: "Generated {at} — workspace data only.",
    navAria: "Recruiter workspace sections",
  },
  recruiterCalendar: {
    eyebrow: "Roadmap",
  ...
  recruiterScheduling: {
    ...
    manualSchedulingNote:
      "Enter date, time, and optional meeting link. Copy the invite and send it from your own email or calendar.",
    notSentDisclaimer: "TWIN does not send this invite. Copy and send it yourself.",
    calendarSyncNotLive: "Full recruiter calendar sync is not live.",
    ...
    meetingLinkPlaceholder: "Paste Teams, Meet, or Zoom link",
    inviteMessageLabel: "Invite message",
    copyInvite: "Copy invite",
    copied: "Copied",
    markInvited: "Mark as invited",
    markScheduled: "Mark as scheduled",
    close: "Close",
    saveFailed: "Could not save scheduling — check date and time, then try again.",
    statusInvited: "Invited (manual)",
    statusInterviewScheduled: "Interview scheduled (manual)",
    durationMinutesSuffix: "{minutes} min",
    inviteBodyTemplate:
      "Hi{candidateName},\n\nWe would like to invite you to an interview for {role} at {company}.\n\nProposed time: {date} at {time} ({duration} minutes).\n{meetingLink}\n\nPlease confirm if this works for you.\n\nBest regards",
    inviteLinkLine: "Join link: {meetingLink}",
  },
  recruiterPipeline: {
    title: "Recruiter pipeline",
    lead:
      "ATS-lite stages after acceptance — track who to contact, invite, or hold. Pilot view only; no external email or calendar sync.",
    trustLine:
      "Pilot pipeline — manual scheduling only; recruiter calendar sync not live; no external email from TWIN.",
    dataVisibilityNote:
      "Candidate names and match signals only — no email or phone in this pilot pipeline view.",
    navAria: "Recruiter workspace navigation",
    loadFailed: "Could not load pipeline — check access and try again.",
    empty: "No candidates in this pipeline stage right now.",
    ...
    nextActionReview: "Review and accept or decline in inbox",
    nextActionAccepted: "Move to contact or prepare invite",
    nextActionToContact: "Prepare interview invite",
    nextActionInvited: "Await candidate response",
    nextActionRejected: "Archived — reopen from pipeline if needed",
    nextActionOnHold: "Resume or reject when ready",
  },
  companyDashboard: {
    eyebrow: "Company workspace",
    title: "Hiring dashboard",
    lead:
      "Executive view of open roles and pipeline health for your company — counts from your workspace only. No time-to-hire, revenue, or hire claims.",
    navDashboard: "Dashboard",
    navInbox: "Acceptance inbox",
    navAria: "Company workspace",
    workspaceLine: "Workspace · {company}",
    pilotBannerTitle: "Pilot — public launch NO-GO",
    pilotBannerBody:
      "This dashboard reflects real pilot workspace data when loaded. Employer SSO, ATS webhooks, and self-serve billing are not live. TWIN does not invent traction metrics.",
    metricOpenRoles: "Open roles",
    metricPipeline: "In pipeline",
    metricPending: "Pending review",
    metricAccepted: "Accepted / invited",
    metricRejected: "Rejected",
    metricOnHold: "On hold",
    metricMissingData: "Missing data flags",
    metricMissingDataHint: "Profiles with gaps before scheduling",
    metricVerification: "Verification pending",
    metricVerificationHint: "Placement checks not yet verified",
    teamActivityTitle: "Team activity (7 days)",
    teamActivityBody: "{count} application updates in the last 7 days for this company slug.",
    rolesTitle: "By role",
    rolesLead: "Candidate counts per open role — no names or contact details.",
    rolesEmpty: "No pipeline rows for this company yet. Post a role or load demo workspace data.",
    roleCandidates: "{count} candidates",
    rolePending: "{count} pending",
    roleAccepted: "{count} accepted",
    roleRejected: "{count} rejected",
    ...
    integration_acceptanceInbox: "Acceptance inbox & review card",
    integration_atsWebhooks: "ATS webhooks",
    integration_employerSso: "Employer SSO",
    integration_calendarSync: "Recruiter calendar sync",
    integration_billingSelfServe: "Self-serve billing & seats",
    integrationLive: "Live",
    integrationPlanned: "Planned",
    integrationNotLive: "Not live",
    scopeNote:
      "Counts only — this dashboard does not show time-to-hire, revenue, hires made, or candidate PII.",
    ctaInbox: "Open acceptance inbox",
    ctaStory: "Employer product story",
    authEyebrow: "Load workspace",
    authLead: "Enter your pilot access code and company to load hiring metrics for your slug.",
    missingAuth: "Enter your access code and choose a company to load the dashboard.",
    loading: "Loading dashboard…",
    loadCta: "Load hiring dashboard",
  },
  acceptanceQueue: {
...
const pl: MessageTree = {
  ...
  workspace: {
    ...
    toolRecruiterAnalytics: "Liczby pipeline dla slug firmy — nie trakcja marketplace.",
...
eyebrow: "Roadmapa produktu",
  ...
  recruiterAnalytics: {
    ...
    title: "Analityka",
    lead:
      "Liczby ze skrzynki akceptacji i pipeline dla jednego slug firmy. Kształt kolejki — nie trakcja całej platformy.",
    demoDisclaimer: "Analityka workspace/demo — nie trakcja marketplace.",
    scopeNote:
      "Tylko dla Twojego tokena i slug firmy. Bez sum sieci rekruterów, przychodu z placementów ani benchmarków time-to-hire.",
    loading: "Ładowanie metryk workspace…",
    loadFailed: "Nie udało się załadować analityki — sprawdź kod dostępu i slug firmy.",
    metricInReview: "W przeglądzie",
    metricAccepted: "Zaakceptowani",
    metricRejected: "Odrzuceni",
    metricOnHold: "Wstrzymani",
    metricInvited: "Zaproszeni / zaplanowani",
    metricAvgMatch: "Śr. wynik dopasowania",
    metricMissingData: "Brakujące dane",
    metricDecisionsWeek: "Decyzje w tym tygodniu",
    metricTotal: "Razem w workspace",
    noData: "—",
    funnelTitle: "Lejek pipeline",
    funnelHint: "Segmenty z aplikacji w workspace — tylko względne słupki.",
    segmentOnHold: "Wstrzymani",
    segmentInReview: "W przeglądzie",
    segmentAccepted: "Zaakceptowani",
    segmentRejected: "Odrzuceni",
    generatedAt: "Wygenerowano {at} — tylko dane workspace.",
    navAria: "Sekcje workspace rekrutera",
  },
  recruiterCalendar: {
    eyebrow: "Roadmapa",
  ...
  recruiterScheduling: {
    ...
    manualSchedulingNote:
      "Podaj datę, godzinę i opcjonalny link do spotkania. Skopiuj zaproszenie i wyślij je własnym kanałem.",
    notSentDisclaimer: "TWIN nie wysyła tego zaproszenia. Skopiuj i wyślij samodzielnie.",
    calendarSyncNotLive: "Pełna synchronizacja kalendarza rekrutera nie jest live.",
    calendarSyncLink: "Roadmapa kalendarza rekrutera",
    prepareInviteAction: "Przygotuj zaproszenie na rozmowę",
    dateLabel: "Data rozmowy",
    timeLabel: "Godzina rozmowy",
    durationLabel: "Czas trwania (minuty)",
    meetingLinkLabel: "Link do spotkania (opcjonalnie)",
    meetingLinkPlaceholder: "Wklej link Teams, Meet lub Zoom",
    inviteMessageLabel: "Treść zaproszenia",
    copyInvite: "Kopiuj zaproszenie",
    copied: "Skopiowano",
    markInvited: "Oznacz jako zaproszony",
    markScheduled: "Oznacz jako umówiony",
    close: "Zamknij",
    saveFailed: "Nie udało się zapisać terminu — sprawdź datę i godzinę.",
    statusInvited: "Zaproszony (ręcznie)",
    statusInterviewScheduled: "Rozmowa umówiona (ręcznie)",
    durationMinutesSuffix: "{minutes} min",
    inviteBodyTemplate:
      "Cześć{candidateName},\n\nChcielibyśmy zaprosić Cię na rozmowę na stanowisko {role} w {company}.\n\nProponowany termin: {date} o {time} ({duration} min).\n{meetingLink}\n\nDaj proszę znać, czy termin Ci pasuje.\n\nPozdrawiamy",
    inviteLinkLine: "Link do spotkania: {meetingLink}",
  },
  recruiterPipeline: {
    title: "Pipeline rekrutera",
    lead:
      "Etapy ATS-lite po akceptacji — kogo kontaktować, zaprosić lub wstrzymać. Widok pilotażowy; bez zewnętrznej poczty i sync kalendarza.",
    trustLine:
      "Pipeline pilotażowy — tylko ręczne planowanie; sync kalendarza rekrutera nie jest live; brak zewnętrznej poczty z TWIN.",
    dataVisibilityNote:
      "Tylko imiona i sygnały dopasowania — bez e-maila ani telefonu w tym widoku pilotażowym.",
    navAria: "Nawigacja workspace rekrutera",
    loadFailed: "Nie udało się wczytać pipeline — sprawdź dostęp.",
    empty: "Brak kandydatów na tym etapie pipeline.",
    scheduledSlot: "Umówiony termin",
    openInInbox: "Otwórz w skrzynce",
    filterAll: "Wszystkie etapy",
    filterReview: "Do oceny",
    ...
    nextActionReview: "Oceń i zaakceptuj lub odrzuć w skrzynce",
    nextActionAccepted: "Przenieś do kontaktu lub przygotuj zaproszenie",
    nextActionToContact: "Przygotuj zaproszenie na rozmowę",
    nextActionInvited: "Czekaj na odpowiedź kandydata",
    nextActionRejected: "Zarchiwizowany — wznów z pipeline w razie potrzeby",
    nextActionOnHold: "Wznów lub odrzuć, gdy będziesz gotowy",
  },
  companyDashboard: {
    eyebrow: "Przestrzeń firmy",
    title: "Panel rekrutacji",
    lead:
      "Widok zarządczy otwartych ról i kondycji pipeline dla Twojej firmy — liczby tylko z workspace. Bez time-to-hire, przychodu ani twierdzeń o zatrudnieniach.",
    navDashboard: "Panel",
    navInbox: "Skrzynka akceptacji",
    navAria: "Przestrzeń firmy",
    workspaceLine: "Workspace · {company}",
    pilotBannerTitle: "Pilotaż — publiczny start NO-GO",
    pilotBannerBody:
      "Panel pokazuje realne dane pilotażowego workspace po załadowaniu. SSO pracodawcy, webhooki ATS i self-serve billing nie są live. TWIN nie wymyśla metryk trakcji.",
    metricOpenRoles: "Otwarte role",
    metricPipeline: "W pipeline",
    metricPending: "Oczekuje na decyzję",
    metricAccepted: "Zaakceptowani / zaproszeni",
    metricRejected: "Odrzuceni",
    metricOnHold: "Wstrzymani",
    metricMissingData: "Braki w danych",
    metricMissingDataHint: "Profile z lukami przed planowaniem",
    metricVerification: "Weryfikacja w toku",
    metricVerificationHint: "Kontrole placement bez potwierdzenia",
    teamActivityTitle: "Aktywność zespołu (7 dni)",
    teamActivityBody: "{count} aktualizacji aplikacji w ostatnich 7 dniach dla tego slug firmy.",
    rolesTitle: "Według roli",
    rolesLead: "Liczba kandydatów na rolę — bez imion i danych kontaktowych.",
    rolesEmpty: "Brak wierszy pipeline dla tej firmy. Opublikuj rolę lub załaduj dane demo workspace.",
    roleCandidates: "{count} kandydatów",
    rolePending: "{count} oczekuje",
    roleAccepted: "{count} zaakceptowanych",
    roleRejected: "{count} odrzuconych",
    integrationsTitle: "Gotowość integracji",
    integrationsLead: "Co jest live, a co planowane — uczciwy zakres pilotażu.",
    integration_acceptanceInbox: "Skrzynka akceptacji i karta oceny",
    integration_atsWebhooks: "Webhooki ATS",
    integration_employerSso: "SSO pracodawcy",
    integration_calendarSync: "Sync kalendarza rekrutera",
    integration_billingSelfServe: "Self-serve billing i miejsca",
    integrationLive: "Live",
    integrationPlanned: "Planowane",
    integrationNotLive: "Nie live",
    scopeNote:
      "Tylko liczby — panel nie pokazuje time-to-hire, przychodu, zatrudnień ani PII kandydatów.",
    ctaInbox: "Otwórz skrzynkę akceptacji",
    ctaStory: "Opis produktu dla pracodawców",
    authEyebrow: "Załaduj workspace",
    authLead: "Podaj kod pilotażowy i firmę, aby załadować metryki rekrutacji dla swojego slug.",
    missingAuth: "Podaj kod dostępu i wybierz firmę, aby załadować panel.",
    loading: "Ładowanie panelu…",
    loadCta: "Załaduj panel rekrutacji",
  },
  acceptanceQueue: {
