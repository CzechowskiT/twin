...
const en = {
  ...
  calculator: {
    ...
    timeSavingsSub: "{{hours}} h/mo × {{rate}}/h × 12 months",
...
const pl: MessageTree = {
  ...
  calculator: {
    ...
    timeSavingsSub: "{{hours}} h/mies. × {{rate}} USD/h × 12 mies.",
