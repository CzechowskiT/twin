...
const en = {
  ...
  dashboard: {
    ...
    nightlyAutoApplyLink: "Nightly auto-apply",
    nightlyAutoApplyTitle: "Nightly auto-apply",
    nightlyAutoApplyLead: "TWIN applies to your best matches while you sleep (Pracuj.pl today).",
    nightlyAutoApplyEnable: "Enable nightly auto-apply",
    nightlyAutoApplyEnabledHint: "Runs daily at {time} for matches above your score threshold.",
...
const pl: MessageTree = {
  nav: {
    ...
    logoutToSwitchRole: "Wyloguj się, aby zmienić rolę",
  ...
  dashboard: {
    ...
    nightlyAutoApplyLink: "Auto-aplikowanie nocne",
    nightlyAutoApplyTitle: "Auto-aplikowanie nocne",
    nightlyAutoApplyLead:
      "TWIN aplikuje do najlepszych dopasowań, gdy śpisz (na razie Pracuj.pl).",
    nightlyAutoApplyEnable: "Włącz auto-aplikowanie nocne",
