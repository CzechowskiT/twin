...
const en = {
  ...
  dashboard: {
    ...
    matchLaneIdeal: "Ready now",
    matchLaneNear: "Near-miss · upskill",
    matchLaneStretch: "Stretch · practice",
...
const pl: MessageTree = {
  ...
  dashboard: {
    ...
    matchLaneIdeal: "Gotowe teraz",
    matchLaneNear: "Blisko · doszkolenie",
    matchLaneStretch: "Aspiracyjne · trening",
