...
const en = {
  ...
  dashboard: {
    ...
    regionGlobal: "Global",
    topMatches: "Recommended shortlist",
    topMatchesLead: "Help us rate fit — your feedback improves the next shortlist.",
...
const pl: MessageTree = {
  ...
  dashboard: {
    ...
    topMatches: "Shortlista rekomendacji",
    topMatchesLead: "Pomóż ocenić trafność — Twój feedback poprawia kolejną shortlistę.",
