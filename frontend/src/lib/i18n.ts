...
eyebrow: "Product roadmap",
  ...
  companyTalentPool: {
    ...
    trustCopy:
      "Company talent memory is internal only — no automatic outreach, no live ATS sync. Recruiter review required before contact.",
...
const pl: MessageTree = {
  ...
  companyTalentPool: {
    ...
    trustCopy:
      "Pamięć talentów firmy jest tylko wewnętrzna — bez automatycznego outreachu, bez live sync ATS. Wymagana recenzja rekrutera przed kontaktem.",
