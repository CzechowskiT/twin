...
const en = {
  ...
  home: {
    ...
    ctaDemoHint: "Live matches + timed auto-apply walkthrough. No account required.",
  ...
  dashboard: {
    ...
    demoHeroHint: "Run the interactive auto-apply story and live apply on the seeded demo job.",
  ...
  demo: {
    ...
    stepScanJobs: "Scan job boards",
    stepMatch: "Match score locks in",
    stepTailor: "Tailor CV & cover note",
    stepSubmit: "Submit on the board flow",
    stepCalendar: "Hold interview slot",
    stepDetail0: "pracuj.pl + rocketjobs.pl in parallel",
    stepDetail1: "Rule-based matcher — same as dashboard",
    stepDetail2: "Pitch + bullets aligned to the listing",
    stepDetail3: "Playwright fills fields; PDF attaches",
    stepDetail4: "ICS / Google Calendar when connected",
    stepPending: "Waiting",
    stepActive: "In progress…",
    stepDone: "Complete",
    matchLocked: "High match",
    theaterScanTitle: "Fresh listings",
    theaterTailorTitle: "Tailored package",
    theaterTailorBody: "CV highlights + short cover note tuned to SynthRail’s stack.",
    theaterCalendarTitle: "Calendar hold",
    theaterCalendarSlot: "Thu 10:30 · 45 min · Intro with hiring team",
    theaterCalendarHint: "Accept / decline / reschedule — not another inbox thread.",
    queuedEyebrow: "Pipeline",
    queuedTitle: "Application queued",
    queuedBody:
      "Tracker updated. In production this becomes a real submission when you sign in and consent — the story you just watched is the same path.",
...
const pl: MessageTree = {
  ...
  home: {
    ...
    ctaDemoHint: "Dopasowania na żywo + symulacja auto-aplikacji. Bez konta.",
  ...
  dashboard: {
    ...
    demoHeroHint: "Uruchom interaktywne demo auto-aplikacji i live apply na ofercie z seeda.",
  ...
  demo: {
    ...
    pageTitle: "Od skanu CV do aplikacji: jedna spokojna ścieżka",
    pageLead:
    ...
    simulationBody:
      "Zaloguj się, aby uruchomić prawdziwą auto-aplikację na ofercie demo z seeda (pracuj.pl). Bez logowania przycisk poniżej odtwarza scenariusz czasowo — bez wywołań API.",
    liveApplyTitle: "Live apply: prawdziwe wysłanie na ofercie demo",
    liveApplyBody:
      "Jesteś zalogowany. „Uruchom prawdziwą auto-aplikację” woła POST /api/v1/applications/auto-apply na ofercie investor-demo (ten sam endpoint co w panelu). Wymaga CV w profilu i zgody tam, gdzie jest włączona.",
    runRealCta: "Uruchom prawdziwą auto-aplikację",
    ...
    runCta: "Odtwórz scenariusz auto-aplikacji",
    runningCta: "Trwa…",
    replayCta: "Odtwórz ponownie",
    soundToggle: "Efekty dźwiękowe",
    ...
    flowTitle: "Sekwencja auto-aplikacji",
    stepScanJobs: "Skan portali z ofertami",
    stepMatch: "Wynik dopasowania się domyka",
    stepTailor: "Dopasowanie CV i notki",
    stepSubmit: "Wysłanie w flow portalu",
    stepCalendar: "Rezerwacja slotu w kalendarzu",
    stepDetail0: "pracuj.pl + rocketjobs.pl równolegle",
    stepDetail1: "Matcher regułowy — jak w panelu",
    stepDetail2: "Pitch i punkty pod konkretną ofertę",
    stepDetail3: "Playwright wypełnia pola; PDF w załączniku",
    stepDetail4: "ICS / Google Calendar po podłączeniu",
    stepPending: "Oczekuje",
    stepActive: "W toku…",
    stepDone: "Gotowe",
    matchLocked: "Wysokie dopasowanie",
    theaterScanTitle: "Świeże oferty",
    theaterTailorTitle: "Spakowany materiał",
    theaterTailorBody: "Akcenty CV + krótka notka pod stack SynthRail.",
    theaterCalendarTitle: "Blok w kalendarzu",
    theaterCalendarSlot: "Czw. 10:30 · 45 min · Intro z zespołem",
    theaterCalendarHint: "Akceptuj / odrzuć / przełóż — bez wątku mailowego.",
    queuedEyebrow: "Pipeline",
    queuedTitle: "Aplikacja w kolejce",
    queuedBody:
      "Tracker zaktualizowany. W produkcji to realne wysłanie po logowaniu i zgodzie — scenariusz, który właśnie obejrzałeś, to ta sama ścieżka.",
