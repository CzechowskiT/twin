...
const en = {
  ...
  login: {
    ...
    zoneInvestorLead: "Company programs, scenario calculator, and procurement-facing pages.",
...
const pl: MessageTree = {
  ...
  login: {
    ...
    zoneInvestorLead: "Programy firmowe, kalkulator scenariusza i strony dla procurement.",
