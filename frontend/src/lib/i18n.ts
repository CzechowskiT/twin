...
const en = {
  ...
  marketingHowItWorks: {
    ...
    title: "From profile to acceptance-ready calendar — not inbox spam",
    lead: "TWIN matches while you are away, applies with your consent on supported boards, and lands interviews on calendars you already use.",
...
const pl: MessageTree = {
  ...
  marketingHowItWorks: {
    ...
    title: "Od profilu do kalendarza wartościowych rozmów — bez spamu w skrzynce",
    lead: "TWIN dopasowuje, gdy jesteś offline, aplikuje za Twoją zgodą na wspieranych portalach i ląduje rozmowami w kalendarzu, którego już używasz.",
    ctaStart: "Zacznij",
    ctaDemo: "Zobacz demo",
  },
  verifyEmail: {
