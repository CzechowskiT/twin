...
export function getImplementationTrackerDemo(): ImplementationTrackerRecord {
  const persistence_features = [
    ...
    row(
      "placement_events",
      "implementationTracker.featurePlacementEvents",
      "pilot",
      "implementationTracker.nextPlacementEventsUi",
      "implementationTracker.depEventSchema",
      "implementationTracker.boundaryAppendOnly",
      "Backend",
      "P0",
    ...
    row(
      "p0_performance_inventory",
      "implementationTracker.featureP0PerformanceInventory",
      "demo",
      "implementationTracker.nextP0LowRiskHardening",
