...
export const PILOT_STANCE = "TECHNICALLY_READY_BUT_CUSTOMER_JOURNEY_INCOMPLETE" as const;
...
export const CONTROLLED_PILOT_OS_VERDICT =
  "CUSTOMER-USABLE MULTI-ROLE PILOT JOURNEY INCOMPLETE — EXACT BLOCKERS" as const;
