...
export const FOUNDER_LED_DEMO_JOURNEY_STEPS: readonly FounderLedDemoLink[] = [
  ...
  },
  {
    ...
    requiresAuth: true,
    loginPath: "/login",
    titleKey: "candidateTrustAuditExport.demoJourneyTitle",
    descKey: "candidateTrustAuditExport.demoJourneyDesc",
  },
  {
  ...
  },
  {
    ...
    descKey: "recruiterTrustReviewQueue.demoJourneyDesc",
  },
  {
    id: "daily_cockpit",
  ...
  },
  {
    ...
    href: firstWorkingPersistencePlanHref(),
    requiresAuth: false,
