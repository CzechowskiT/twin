...
const companiesEn: PersonaBundle = {
  ...
  tiers: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Google Calendar interview holds + ICS/WebCal export (where Google OAuth is configured)",
    ...
    },
    {
      ...
      bullets: [
        ...
        "ATS outbound webhooks (roadmap — scaffold today) + employer one-click placement attestation (pilot)",
        "Machine-assisted placement verification (no email ping-pong default)",
        "Microsoft 365 org calendars (coming soon) + Google Calendar holds where configured",
    ...
    },
    {
      ...
      bullets: [
        ...
        "Bi-directional ATS sync workshops (roadmap — not live writeback) + private integration SLA",
  ...
  stackedCta: { label: "Talent pool (limited pilot preview)", href: "/company/talent-pool" },
...
const companiesPl: PersonaBundle = {
  ...
  tiers: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Google Calendar + eksport ICS/WebCal na sloty rozmów (gdy OAuth Google skonfigurowany)",
    ...
    },
    {
      ...
      bullets: [
        ...
        "Webhooki ATS (roadmapa — dziś scaffold) + jednoklikowa atestacja placementu (pilotaż)",
        "Weryfikacja placementu maszynowo — bez domyślnego ping-pongu mailowego",
        "Kalendarze org Microsoft 365 (wkrótce) + Google Calendar tam, gdzie skonfigurowany",
    ...
    },
    {
      ...
      bullets: [
        ...
        "Warsztaty sync ATS dwukierunkowy (roadmapa — bez live writeback) + prywatne SLA integracji",
  ...
  stackedCta: { label: "Pula talentów (ograniczony pilot — podgląd)", href: "/company/talent-pool" },
