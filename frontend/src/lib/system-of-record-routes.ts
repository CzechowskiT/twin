...
export const SYSTEM_OF_RECORD_ROUTES: readonly SystemOfRecordRouteEntry[] = [
  ...
  },
  {
    ...
    titleKey: "workspaceModules.candidateControlCenterTitle",
    descriptionKey: "workspaceModules.candidateControlCenterValue",
    hintKey: "workspaceModules.candidateControlCenterHint",
    ctaKey: "workspaceModules.candidateControlCenterCta",
    status: "pilot",
    moduleFamily: "trust",
    boundaryTags: ["pilot", "human_decision_required", "no_outreach"],
  },
  {
    ...
    titleKey: "workspaceModules.candidateExportPreviewTitle",
    descriptionKey: "workspaceModules.candidateExportPreviewValue",
    hintKey: "workspaceModules.candidateExportPreviewHint",
    ctaKey: "workspaceModules.candidateExportPreviewCta",
    status: "pilot",
    moduleFamily: "trust",
  ...
  },
  {
    ...
    titleKey: "workspaceModules.candidateCorrectionRequestTitle",
    descriptionKey: "workspaceModules.candidateCorrectionRequestValue",
    hintKey: "workspaceModules.candidateCorrectionRequestHint",
    ctaKey: "workspaceModules.candidateCorrectionRequestCta",
    status: "pilot",
    moduleFamily: "trust",
    boundaryTags: ["pilot", "not_live", "human_decision_required", "no_outreach"],
  },
  {
    id: "candidate_identity_verification",
    persona: "candidate",
    href: CANDIDATE_CANONICAL_ROUTES.trustIdentityVerification,
    titleKey: "workspaceModules.candidateIdentityVerificationTitle",
    descriptionKey: "workspaceModules.candidateIdentityVerificationValue",
    hintKey: "workspaceModules.candidateIdentityVerificationHint",
    ctaKey: "workspaceModules.candidateIdentityVerificationCta",
    status: "pilot",
    moduleFamily: "trust",
    boundaryTags: ["pilot", "not_live", "human_decision_required", "no_outreach"],
  },
  {
    ...
    titleKey: "workspaceModules.candidateDataPortabilityTitle",
    descriptionKey: "workspaceModules.candidateDataPortabilityValue",
    hintKey: "workspaceModules.candidateDataPortabilityHint",
    ctaKey: "workspaceModules.candidateDataPortabilityCta",
    status: "pilot",
    moduleFamily: "trust",
    boundaryTags: ["pilot", "not_live", "human_decision_required", "no_outreach"],
  },
  {
    ...
    titleKey: "workspaceModules.candidateRevokeDeleteTitle",
    descriptionKey: "workspaceModules.candidateRevokeDeleteValue",
    hintKey: "workspaceModules.candidateRevokeDeleteHint",
    ctaKey: "workspaceModules.candidateRevokeDeleteCta",
    status: "pilot",
    moduleFamily: "trust",
    boundaryTags: ["pilot", "not_live", "human_decision_required", "no_outreach"],
  },
  {
    ...
    titleKey: "workspaceModules.candidateTrustAuditExportTitle",
    descriptionKey: "workspaceModules.candidateTrustAuditExportValue",
    hintKey: "workspaceModules.candidateTrustAuditExportHint",
    ctaKey: "workspaceModules.candidateTrustAuditExportCta",
    status: "pilot",
    moduleFamily: "trust",
    boundaryTags: ["pilot", "not_live", "human_decision_required"],
  },
  ...
  },
  {
    ...
    persona: "candidate",
    href: CANDIDATE_CANONICAL_ROUTES.trustOverview,
    titleKey: "workspaceModules.candidateTrustOverviewTitle",
    descriptionKey: "workspaceModules.candidateTrustOverviewValue",
    hintKey: "workspaceModules.candidateTrustOverviewHint",
    ctaKey: "workspaceModules.candidateTrustOverviewCta",
    status: "pilot",
    moduleFamily: "trust",
    boundaryTags: ["pilot", "not_live", "human_decision_required", "no_outreach"],
  },
  ...
  },
  {
    ...
    persona: "investor",
    href: "/board/working-features-readiness",
    titleKey: "workingFeaturesReadiness.demoJourneyTitle",
    descriptionKey: "workingFeaturesReadiness.demoJourneyDesc",
    ctaKey: "workingFeaturesReadiness.pageTitle",
    status: "pilot",
    moduleFamily: "trust",
    boundaryTags: ["pilot", "human_decision_required", "no_outreach"],
  ...
  },
  {
    ...
    descriptionKey: "implementationTracker.demoJourneyDesc",
    ctaKey: "implementationTracker.pageTitle",
    status: "pilot",
    moduleFamily: "trust",
    boundaryTags: ["pilot", "human_decision_required", "no_outreach", "not_live"],
    investorGroup: "boardEvidence",
  ...
  },
  {
    ...
    descriptionKey: "firstWorkingPersistencePlan.demoJourneyDesc",
    ctaKey: "firstWorkingPersistencePlan.pageTitle",
    status: "pilot",
    moduleFamily: "trust",
    boundaryTags: ["pilot", "human_decision_required", "no_outreach", "not_live"],
    investorGroup: "boardEvidence",
  },
  {
    ...
    descriptionKey: "auditEventFoundation.demoJourneyDesc",
  ...
  },
  {
    ...
    descriptionKey: "investorTrustProof.demoJourneyDesc",
    ctaKey: "investorTrustProof.linkProductProof",
    status: "pilot",
    moduleFamily: "trust",
    boundaryTags: ["pilot", "human_decision_required", "no_outreach"],
    investorGroup: "investorProduct",
