...
> = {
  ...
  candidate_referrals: {
    ...
    gapsSummary: "Founder browser smoke pending — NEEDS_FOUNDER_AUTH_SMOKE; rewards remain manual.",
    nextAction: "Persistence shipped — run founder browser smoke on /dashboard/referrals with demo@twin.career.",
    dependencies: ["candidate_profile"],
    effort: "M",
    targetWave: "B",
    owner: "candidate-squad",
