...
> = {
  candidate_career_compass: {
    ...
    worksSummary: "Static framework + profile-backed read path.",
    gapsSummary: "No full persistence layer — goals and progress reset across sessions.",
    nextAction: "Wave B slice 1 — wire Career Compass to production persistence API.",
  ...
  candidate_trust: {
    ...
    worksSummary: "Overview UI + deep links to trust subflows.",
    gapsSummary: "Advanced compliance lanes preview-only; no production writeback.",
    nextAction: "Wave B — connect trust overview to audit event stream.",
    dependencies: ["candidate_profile"],
    effort: "L",
    targetWave: "B",
    owner: "candidate-squad",
  ...
  trust_center: {
    ...
    worksSummary: "Routes to trust overview.",
    gapsSummary: "Subflows preview-only.",
    nextAction: "Wave B — trust persistence + consent receipts.",
