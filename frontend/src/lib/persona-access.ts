...
const PATH_IMPLIES_PERSONA: { prefix: string; persona: MarketingPersona }[] = [
  ...
  { prefix: "/workspace/candidate/jobs", persona: "candidate" },
...
const PREFIX_ALLOWED: { prefix: string; allowed: readonly MarketingPersona[] }[] = [
  ...
  { prefix: "/workspace/candidate/jobs", allowed: ["candidate"] },
  ...
  { prefix: "/recruiter/employer", allowed: ["recruiter", "investor"] },
