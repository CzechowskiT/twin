...
export const PRODUCTION_PERSISTENCE_STATUS_LINKS = [
  ...
  { href: "/board/placement-verification", labelKey: "boardPlacementEvidence.pageTitle" as TranslationKey },
  { href: "/board/calendar-readiness", labelKey: "boardCalendarReadiness.pageTitle" as TranslationKey },
  { href: "/board/microsoft-busy-read-staging-checklist", labelKey: "boardMicrosoftBusyReadStagingChecklist.pageTitle" as TranslationKey },
