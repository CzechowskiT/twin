...
const es: ProfilePipelineTrustOverlay = {
  ...
  jobPipeline: {
    ...
    boundaryBody:
      "TWIN clasifica y muestra candidatos por vacante — el reclutador decide movimientos de etapa, contacto y ofertas. Sin auto-aplicación, sin contacto saliente automático, sin escrituras ocultas en ATS en este piloto.",
  },
...
const it: ProfilePipelineTrustOverlay = {
  candidateProfile360: {
    ...
    boundaryBody:
      "TWIN prepara segnali e memoria — il recruiter decide shortlist, posticipa, scarta e contatto. Nessuna auto-candidatura, nessun contatto in uscita automatico, nessun contatto nascosto col candidato.",
  },
  jobPipeline: {
    pageEyebrow: "Pipeline della posizione",
    pageTitle: "Pipeline di recruiting",
    boundaryBody:
      "TWIN classifica e mostra i candidati per ruolo — il recruiter decide spostamenti di fase, contatto e offerte. Nessuna auto-candidatura, nessun contatto in uscita automatico, nessuna scrittura ATS nascosta in questo pilota.",
  },
  candidateTrustCenter: {
...
const fr: ProfilePipelineTrustOverlay = {
  candidateProfile360: {
    ...
    boundaryBody:
      "TWIN prépare signaux et mémoire — le recruteur décide shortlist, report, rejet et contact. Pas d'auto-candidature, pas de contact sortant automatique, pas de contact caché avec le candidat.",
  },
  jobPipeline: {
    pageEyebrow: "Pipeline du poste",
    pageTitle: "Pipeline de recrutement",
    boundaryBody:
      "TWIN classe et affiche les candidats par poste — le recruteur décide des mouvements d'étape, du contact et des offres. Pas d'auto-candidature, pas de contact sortant automatique, pas d'écriture ATS cachée sur ce pilote.",
  },
  candidateTrustCenter: {
...
const de: ProfilePipelineTrustOverlay = {
  candidateProfile360: {
    ...
    boundaryBody:
      "TWIN bereitet Signale und Historie vor — Recruiter entscheiden über Shortlist, Snooze, Ablehnung und Kontakt. Kein Auto-Apply, kein automatischer Outbound, kein versteckter Kandidatenkontakt.",
  },
  jobPipeline: {
    pageEyebrow: "Stellen-Pipeline",
    pageTitle: "Recruiting-Pipeline",
    boundaryBody:
      "TWIN rankt und zeigt Kandidaten pro Rolle — Recruiter entscheiden über Phasenwechsel, Kontakt und Angebote. Kein Auto-Apply, kein automatischer Outbound, keine versteckten ATS-Schreibvorgänge in diesem Pilot.",
  },
  candidateTrustCenter: {
    pageTitle: "Kandidaten-Vertrauenszentrum",
    boundaryBody:
      "TWIN zeigt, was wir speichern, was Recruiter sehen und wie Sie es steuern können. Kein Auto-Apply, kein automatisierter Outreach, keine KI-Einstellungsurteile — Sie entscheiden, wann Sie sich bewerben und wer Kontakt aufnimmt.",
  },
  candidateExportPreview: {
...
const zh: ProfilePipelineTrustOverlay = {
  ...
  jobPipeline: {
    ...
    pageTitle: "招聘管道",
    boundaryBody:
      "TWIN 按职位排序并展示候选人 — 招聘人员决定阶段移动、外联与 offer。本试点无自动申请、无自动外联、无隐藏 ATS 写入。",
  },
  candidateTrustCenter: {
    pageTitle: "候选人信任中心",
    boundaryBody:
...
const ar: ProfilePipelineTrustOverlay = {
  ...
  jobPipeline: {
    ...
    boundaryBody:
      "TWIN يرتّب ويعرض المرشحين لكل دور — يقرر المُوظّف تحركات المراحل والتواصل والعروض. لا تقديم تلقائي، لا تواصل صادر تلقائي، لا كتابة ATS مخفية في هذا الطيار.",
  },
  candidateTrustCenter: {
