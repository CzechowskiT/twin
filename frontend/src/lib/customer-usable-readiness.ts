...
export const CUSTOMER_USABLE_REGISTRY: readonly CustomerUsableModule[] = [
  ...
  // --- AI Candidate Intelligence (explainable screening) ---
  {
    ...
    note: "WS20 prod synthetic E2E PASS — structured profile + timeline + brief",
    evidence_tier: "production_smoked_synthetic",
  },
  {
    ...
    disposition: "CUSTOMER_USABLE",
    route: "/recruiter/candidates/[id]",
    note: "Factual vs inferred brief; human review required; WS20 smoked",
    evidence_tier: "production_smoked_synthetic",
  },
  {
    ...
    disposition: "CUSTOMER_USABLE",
    route: "/recruiter/candidates/[id]",
    note: "MATCH|NO_MATCH|UNKNOWN with strengths/gaps/unknowns; WS20 smoked",
    evidence_tier: "production_smoked_synthetic",
  },
  {
    ...
    status: "CUSTOMER_USABLE_PASS",
    disposition: "CUSTOMER_USABLE",
    note: "Draft only — never auto-send; WS20 draft_unsent PASS",
    evidence_tier: "production_smoked_synthetic",
  },
  {
    module_id: "company_intelligence_subset",
    persona: "company",
    status: "CUSTOMER_USABLE_PASS",
    disposition: "CUSTOMER_USABLE",
    route: "/company/candidates/[candidateId]",
    note: "Approved subset: brief/strengths/gaps/fit/decision flags only",
    evidence_tier: "production_smoked_synthetic",
  },
  {
    module_id: "recruiter_intelligence_compact_cards",
    persona: "recruiter",
    status: "CUSTOMER_USABLE_PASS",
    disposition: "CUSTOMER_USABLE",
    route: "/recruiter/inbox",
    note: "Compact cards on inbox/pipeline/talent-pool list; WS20 keys PASS",
    evidence_tier: "production_smoked_synthetic",
  },
...
export function weightedUsabilityScores(): {
  ...
  return {
    ...
    customer_usable_synthetic_score: Math.min(100, Math.round((syntheticPass / 18) * 100)),
