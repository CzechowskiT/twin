...
export function recruiterInboxReviewCardCtaClass(): string {
  return `${RECRUITER_INBOX_VISUAL_MARKERS.reviewCardCta} ${FOCUS_RING} flex w-full items-center justify-between gap-2 rounded-xl border border-emerald-400/55 bg-emerald-400/18 px-4 py-3 text-sm font-semibold text-emerald-950 shadow-sm transition-colors hover:border-emerald-400/70 hover:bg-emerald-400/28 dark:border-emerald-300/65 dark:bg-emerald-400/22 dark:text-emerald-50 dark:hover:bg-emerald-400/32`;
}
