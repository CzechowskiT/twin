...
export const CANDIDATE_SECONDARY_IA = [
  ...
  { href: "/dashboard/interview-practice", labelKey: "pilotConsolidation.moreInterview" as const, disposition: "keep_secondary" },
  ...
  { href: "/dashboard/settings/access", labelKey: "accessCenter.nav" as const, disposition: "keep_secondary" },
...
export const CANDIDATE_ROUTE_DISPOSITION: Record<string, "primary" | "secondary" | "redirect_home" | "hidden_chrome"> = {
  ...
  "/dashboard/interview-practice": "secondary",
  ...
  "/dashboard/settings/access": "secondary",
