...
/** Apple mark — 24×24 silhouette aligned with Google/GitHub icon size; inherits label color (enabled/disabled rows). */
function AppleIcon() {
  return (
    <svg
      className="block shrink-0 overflow-visible text-current"
      width="20"
      height="20"
      viewBox="0 0 24 24"
      aria-hidden="true"
