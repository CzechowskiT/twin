...
/**
 * Bounded DOM marquee for workspace/auth — ≤18 logo nodes, CSS transform loop,
 * pauses when tab hidden or motion reduced.
 */
  ...
  return (
    ...
    >
      <div className="performance-safe-logo-marquee__viewport overflow-x-clip px-3 sm:px-5" aria-hidden>
        <div className="performance-safe-marquee-track flex w-max items-center py-0.5">
