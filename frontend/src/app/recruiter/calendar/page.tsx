    ...
    <Shell wide>
      <div className="mx-auto max-w-3xl" data-seven-day-recruiter-calendar-roadmap>
        ...
        <Card variant="soft" className="mt-6 border-[var(--twin-accent)]/20 p-5 sm:p-6">
          <p className="text-sm font-semibold text-[var(--foreground)]">{t("recruiterCalendar.notLiveTitle")}</p>
          <p className="twin-muted mt-2 text-sm leading-relaxed">{t("recruiterCalendar.notLiveBody")}</p>
