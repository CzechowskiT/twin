  ...
  return (
    <Shell wide>
      <header className="mb-8 space-y-2">
        ...
        <p className="twin-muted max-w-2xl text-sm leading-relaxed">{t("integrationsHub.leadCompany")}</p>
      </header>
      <IntegrationsHubPanel
        persona="company"
        backHref="/for-companies"
        backLabelKey="integrationsHub.backCompany"
      />
    </Shell>
  );
}
