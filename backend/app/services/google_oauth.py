...
from app.services.auth_oauth_redirect import effective_google_redirect_uri
...
def is_google_configured() -> bool:
    s = get_settings()
    return bool(
        s.google_client_id.strip()
        and s.google_client_secret.strip()
        and effective_google_redirect_uri(s)
    )
...
def build_google_authorize_url(state: str) -> str:
    ...
    s = get_settings()
    redirect_uri = effective_google_redirect_uri(s)
    params = {
        "response_type": "code",
