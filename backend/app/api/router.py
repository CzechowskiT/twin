...
api_router.include_router(
    career_pack_share_public.router,
    tags=["Career Pack Share Public"],
)
api_router.include_router(
...
api_router.include_router(
    candidate_workspace_handoff.router,
    prefix="/candidates",
    tags=["Candidate Workspace Handoffs"],
)
api_router.include_router(
