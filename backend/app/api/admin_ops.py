...
# Keep in sync with alembic head (123_adaptive_execution_intelligence). Epic 2.7 product alignment.
EXPECTED_ALEMBIC_HEAD = "123_adaptive_execution_intelligence"
