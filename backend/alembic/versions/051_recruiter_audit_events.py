...
revision: str = "051_recruiter_audit_events"
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_recruiter_audit_events_application_id",
        "recruiter_audit_events",
        ["application_id"],
    )
    op.create_index(
        "ix_recruiter_audit_events_company_slug",
        "recruiter_audit_events",
        ["company_slug"],
    )
    op.create_index(
        "ix_recruiter_audit_events_created_at",
        "recruiter_audit_events",
        ["created_at"],
    )
